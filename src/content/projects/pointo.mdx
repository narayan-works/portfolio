...
<ProjectSection title="Why build it?" id="problem">
    <p>
...
<ProjectSection title="What's the approach?" id="research">
    <p>
...
<ProjectSection title="How does it work?" id="process">
    <p>
...
<ProjectSection title="What can it do?" id="capabilities">
    <p>
...
<ProjectSection title="How is it built?" id="learnings">
    <p>
